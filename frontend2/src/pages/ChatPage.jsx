  ...
  return (
    <div style={styles.wrap}>
      ...
      <div style={styles.inputBar} className="glass">
        ...
        {history.length > 0 && (
          <button style={styles.clearBtn} onClick={() => setHistory([])} title="Clear Chat">Clear</button>
        )}
      </div>
    </div>
  );
...
const styles = {
  ...
  clearBtn: { padding: '0 16px', background: 'var(--surface2)', border: '1px solid var(--b2)', borderRadius: 'var(--rad)', cursor: 'pointer', fontSize: 16, transition: 'all .2s ease' },
